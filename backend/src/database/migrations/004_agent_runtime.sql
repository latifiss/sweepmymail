...
create index if not exists agent_rate_limit_windows_window_idx on agent_rate_limit_windows (window_start);
...
create unique index if not exists agent_request_events_request_id_idx on agent_request_events (request_id);
create index if not exists agent_request_events_user_created_idx on agent_request_events (user_id, created_at desc);
